...
class Cep(tk.Frame):
    def __init__(self, master):
        ...
        def on_button_click():
            ...
            if validar_cep(cep) == False:
                lbl_resultado.configure(text='CEP Inválido',font=("Arial 20"))
            else:
                cep = verificar_cep(cep)
                try:
